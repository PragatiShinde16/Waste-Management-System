...
<h4>Order summary</h4>
         <p>subtotal( item)</p>
         <p>shipping_fees: Rs 5000</p>
         <p>Total: Rs <?php echo $row['product_price']?>+5000 = <?php echo $row['product_price']+5000 ?> </p>
...
<form action="message.php?id=<?php echo $_GET['id']?>" method="post">
	<script
		...
		data-amount="<?php echo ($row['product_price']+0) ?>"
		data-name="Waste Management System"
