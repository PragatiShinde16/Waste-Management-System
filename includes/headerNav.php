...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
   <a class="brand" href="index.php?id=<?php echo (isset( $_SESSION['customer_name']))? $_SESSION['id']: 'unknown';?>" style="opacity:0.8"><img width="100px" src="./admin/upload/<?php echo $_SESSION['web-img']; ?>" alt="waste management system"/></a>
   <form style='margin-right:4px' class="form-inline navbar-search" method="post" action="./search.php" id='myForm' >
    ...
    <ul id="topMenu" class="nav pull-right">
	 ...
	 <li class=""><a href="contact.php?id=<?php echo (isset( $_SESSION['customer_name']))? $_SESSION['id']: 'unknown';?>">About Us</a></li>
	 <?php 
	   if( isset( $_SESSION['id'])){
	 ?>
