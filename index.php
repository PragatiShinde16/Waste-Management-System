...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide" >
		<div class="carousel-inner">
		  ...
		  <div class="container">
			<img className='imgCarosule' style="width:100%; height:315px" src="images/carousel/4ii.jpg" alt=""/>
		  ...
		  <div class="item">
		  <div class="container">
			<img className='imgCarosule' style="width:100% ; height:315px;cusrsor:pointer" src="images/carousel/4ii.jpg" alt=""/>
			<div class="carousel-caption">
			</div>
		  </div>
		  </div>
		   <div class="item">
		   <div class="container">
			<img className='imgCarosule' style="width:100% ; height:315px;cusrsor:pointer" src="images/carousel/3ii.png" alt=""/>
			<div class="carousel-caption">
...
<a href="product.php?id=<?php echo $row10['product_id']?>"> <div class="product">
	...
	<!-- <p class="price"><b><?php echo $row10['product_price'] ?></b><br><span class="discount"></span></p> -->
