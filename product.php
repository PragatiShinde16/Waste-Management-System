...
<img id='image-pr' src="admin/upload/<?php echo $row11['product_img'] ?>"  alt="product-img">
  ...
  <p class="date"><?php echo $row11['product_date'] ?></p></h5>
	<p class="description-pr"><?php echo $row11['product_desc'] ?> 
	<!-- <p class="price"><br><span class="discount"></span></p> -->
...
<div class="btn-pr">
<a href="payment.php?id=<?php echo $_GET['id']?>" style='text-decoration:none'><p class="button btn1">Ready To Buy</p></a>
<!-- <a href="" style='text-decoration:none'>
  <p class="button btn1" style="width: 220px;">
        <input type="file" name="file" id="file"><br>
        <a href="quality.php">.<input type="submit"></a>
  </p>
  </a> -->
